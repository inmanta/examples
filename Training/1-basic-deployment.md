...
This chapter guides you through the steps of setting up the inmanta orchestrator to manage srlinux devices. The goal is to learn to use the basic functions of the orchestrator.
At the end, we demonstrate [self healing](#self-healing), [dry run / compliance checking](#dry-run) and [how to make updates to the managed infrastructure](#making-changes)
