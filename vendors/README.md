...
* Install the Inmanta software [using this guide]([#install-inmanta](https://docs.inmanta.com/community/latest/install/1-install-server.html#install-the-software)).
